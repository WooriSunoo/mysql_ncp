...
SELECT * FROM user WHERE userid='복숭아' and pw='1111' LIMIT 1;

SELECT * FROM user WHERE userid='복숭아'  LIMIT 1;

UPDATE user SET password='1111', name='최우리d' WHERE userid=복숭아;